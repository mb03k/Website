    ...
    <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-slate-200 z-50">
      <div className="container mx-auto px-6 h-16 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-4 text-slate-500">
            <a href={OUTER_ROUTES.CHESSCOM} target="_blank" rel="noreferrer" className="hover:text-green-600 transition hover:scale-110">
            <ChessPawn className="w-7 h-7" />
            </a>

            <a href={OUTER_ROUTES.GITHUB} target="_blank" rel="noreferrer" className="hover:text-orange-600 transition hover:scale-110">
            <Gitlab className="w-7 h-7" />
            </a>

            <a href={OUTER_ROUTES.GITLAB} target="_blank" rel="noreferrer" className="hover:text-black transition hover:scale-110">
