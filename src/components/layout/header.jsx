      ...
      <div className="container mx-auto px-6 h-16 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-4 text-slate-500">
          <a
            ...
            className="p-2 rounded-full transition-all duration-300 hover:bg-green-100 hover:text-green-600 hover:scale-110"
          >
          ...
          <a
            ...
            className="p-2 rounded-full transition-all duration-300 hover:bg-orange-100 hover:text-orange-600 hover:scale-110"
          >
          ...
          <a
            ...
            className="p-2 rounded-full transition-all duration-300 hover:bg-stone-200 hover:text-stone-600 hover:scale-110"
          >
