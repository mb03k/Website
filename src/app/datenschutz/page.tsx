...
export default function DatenschutzPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 transition-colors dark:bg-slate-950 dark:text-slate-100">
      {/* Header Bereich */}
      <div className="border-b border-slate-200 bg-slate-50/50 py-8 pt-20 dark:border-slate-800 dark:bg-slate-900/50">
        <div className="container mx-auto max-w-3xl px-4">
          <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Datenschutz
          </h1>
          <p className="mt-2 text-slate-500 dark:text-slate-400">
            Rechtliche Hinweise zur Verarbeitung Ihrer Daten.
          </p>
        </div>
      </div>
        ...
        <article className="prose prose-slate max-w-none dark:prose-invert prose-headings:scroll-mt-20 prose-a:text-blue-600 hover:prose-a:text-blue-500 dark:prose-a:text-blue-400">
          <div>
            ...
            <p>
              ...
              und in welchem Umfang verarbeiten. Die Datenschutzerklärung gilt
              für alle von uns durchgeführten Verarbeitungen personenbezogener
            ...
            <div className="my-8 rounded-xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900">
              ...
              <ul className="index !mb-0 grid gap-1 !pl-0">
                {[
                  { href: "#m716", label: "Präambel" },
                  { href: "#m3", label: "Verantwortlicher" },
                  { href: "#mOverview", label: "Übersicht der Verarbeitungen" },
                  { href: "#m2427", label: "Maßgebliche Rechtsgrundlagen" },
                  { href: "#m27", label: "Sicherheitsmaßnahmen" },
                  {
                    href: "#m25",
                    label: "Übermittlung von personenbezogenen Daten",
                  },
                  { href: "#m24", label: "Internationale Datentransfers" },
                  {
                    href: "#m12",
                    label:
                      "Allgemeine Informationen zur Datenspeicherung und Löschung",
                  },
                  { href: "#m10", label: "Rechte der betroffenen Personen" },
                  {
                    href: "#m225",
                    label: "Bereitstellung des Onlineangebots und Webhosting",
                  },
                  { href: "#m134", label: "Einsatz von Cookies" },
                  { href: "#m104", label: "Blogs und Publikationsmedien" },
                  { href: "#m182", label: "Kontakt- und Anfrageverwaltung" },
                  {
                    href: "#m136",
                    label: "Präsenzen in sozialen Netzwerken (Social Media)",
                  },
                  {
                    href: "#m328",
                    label: "Plug-ins und eingebettete Funktionen sowie Inhalte",
                  },
                  { href: "#m15", label: "Änderung und Aktualisierung" },
                  { href: "#m42", label: "Begriffsdefinitionen" },
                ].map((item) => (
                  <li key={item.href} className="list-none !pl-0">
                    <a
                      className="index-link flex items-center gap-2 rounded-md px-2 py-1 text-sm font-medium text-slate-700 no-underline transition-colors hover:bg-slate-200 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
                      href={item.href}
                    >
            ...
            <p>
              ...
              Rahmen der Nutzung von Diensten Dritter oder der Offenlegung bzw.
            ...
            <p>
              ...
              ein Jahr, so startet sie automatisch am Ende des Kalenderjahres,
              in dem das fristauslösende Ereignis eingetreten ist. Im Fall
              laufender Vertragsverhältnisse, in deren Rahmen Daten gespeichert
            ...
            <p>
              ...
              Erstellung von Analysen der Besucherströme. Wir verwenden Cookies
              gemäß den gesetzlichen Vorschriften. Dazu holen wir, wenn
              erforderlich, vorab die Zustimmung der Nutzer ein. Ist eine
            ...
            <ul className="m-elements">
              ...
              <li>
                <strong>Zwecke der Verarbeitung:</strong> Feedback (z. B.
            ...
            <ul className="m-elements">
              <li>
                ...
                Grundlage unserer berechtigten Interessen gespeichert werden.
                ...
                berechtigten Interessen die Angaben der Nutzer zwecks
                ...
                <br />
                <br />
                Die im Rahmen der Kommentare und Beiträge mitgeteilten
            ...
            <p>
              ...
              können beispielsweise anhand des Nutzungsverhaltens und sich
              ...
              Nutzer gespeichert werden. Zudem können in den Nutzungsprofilen
              auch Daten unabhängig der von den Nutzern verwendeten Geräten
              gespeichert werden (insbesondere, wenn sie Mitglieder der
            ...
            <p>
              ...
              Letztere haben jeweils Zugriff auf die Nutzerdaten und können
            ...
            <ul className="m-elements">
              <li>
                ...
                Autorenschaft oder Zeitpunkt der Erstellung). Nutzungsdaten (z.
            ...
            <ul className="m-elements">
              <li>
                <strong>Instagram: </strong>Soziales Netzwerk, ermöglicht das
                Teilen von Fotos und Videos, das Kommentieren und Favorisieren
                von Beiträgen, Nachrichtenversand, Abonnieren von Profilen und
                Seiten; <strong>Dienstanbieter:</strong> Meta Platforms Ireland
            ...
            <p>
              ...
              als „Drittanbieter" bezeichnet) bezogen werden. Dabei kann es sich
            ...
            <p>
              ...
              Nutzer um ihre Einwilligung in den Einsatz der Drittanbieter
              bitten, stellt die Rechtsgrundlage der Datenverarbeitung die
              Erlaubnis dar. Ansonsten werden die Nutzerdaten auf Grundlage
            ...
            <p className="seal mt-12 border-t pt-4 text-sm text-slate-500">
              <a
      ...
      <footer className="border-t border-slate-200 py-6 text-center text-sm text-slate-500 dark:border-slate-800 dark:text-slate-400">
        <p>© {new Date().getFullYear()} Matthes Böttcher</p>
      </footer>
    </div>
  );
}
