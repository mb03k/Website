  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-black px-4 py-20 sm:px-6">
      ...
      <div className="pointer-events-none absolute inset-0 h-full w-full overflow-hidden bg-white dark:bg-slate-950">
        <div className="absolute left-[-50%] top-[-20%] h-[150vw] w-[150vw] animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] rounded-full bg-purple-600/40 blur-[60px] dark:bg-purple-600/30 dark:mix-blend-screen md:left-[-20%] md:h-[80vw] md:w-[80vw] md:bg-purple-600/30 md:mix-blend-screen md:blur-[100px]"></div>
        <div className="absolute bottom-[-20%] right-[-50%] h-[150vw] w-[150vw] animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] rounded-full bg-cyan-600/40 blur-[60px] delay-1000 dark:bg-cyan-600/30 dark:mix-blend-screen md:right-[-20%] md:h-[80vw] md:w-[80vw] md:bg-cyan-600/30 md:mix-blend-screen md:blur-[100px]"></div>
        <div className="animate-spin-slow absolute left-[10%] top-[30%] h-[120vw] w-[120vw] rounded-full bg-pink-600/30 blur-[80px] dark:bg-pink-600/20 dark:mix-blend-screen md:left-[30%] md:h-[60vw] md:w-[60vw] md:bg-pink-600/20 md:mix-blend-screen md:blur-[120px]"></div>
